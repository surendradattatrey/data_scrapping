...
url = paste0("https://www.ratebeer.com/",
             html_attr(first_column,
                       "href"))
score = html_text(
  html_nodes(page,"#tablecontent b"))

count = html_text(html_nodes(page,"font"))
style = html_text(html_nodes(page,"td:nth-child(6) a")) # note that this node also has url of beer style 
